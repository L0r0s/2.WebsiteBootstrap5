            ...
            <div class="col-md-6">
                <div class="card" style="padding: 20px; margin-top: 20px;">
                    ...
                    if (isset($_SESSION['err'])) {
                        echo "<p class='red text-center'>Sign Up error: " . $_SESSION['err'] . "</p>";
                        unset($_SESSION['err']);
                    }
                    ?>
                    <form action="signupDatenbank.php" method="post">
                        <div class="mb-3">
                        ...
                        <div class="d-grid gap-2">
                            ...
                            <input type="button" value="Login" class="btn btn-secondary" onclick="window.location.href='LoginSeitehtml.php'">
                        </div>
                    </form>
                </div>
            </div>
